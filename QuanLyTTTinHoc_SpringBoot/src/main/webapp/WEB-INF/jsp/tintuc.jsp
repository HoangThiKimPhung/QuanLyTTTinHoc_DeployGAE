    	...
    	<div id="tintucChinh" style="display: none;">
            ...
            <div class="col-md-12 line"></div>
	            ...
	            <div class="col-xs-12 col-sm-12 col-md-7 thong-bao-tin-tuc">
		            ...
		            <a id="submittieudechinh" style="margin-top:5px;float:right;color:#bfa145;display:none;cursor:pointer;">Xác nhận</a>
		...
		<div id="TTPhu1" style="display: none">
			<div class="col-xs-12 col-sm-12 col-md-12">
		        ...
		        <div class="col-xs-7 col-sm-7 col-md-8 thong-bao-tin-tuc">
			            ...
			            <a id="submittieudephu1" style="margin-top:5px;float:right;color:#bfa145;display:none;cursor:pointer;">Xác nhận</a>
	    ...
	    <div id="TTPhu2" style="display: none">
	    	<div class="col-xs-12 col-sm-12 col-md-12">
		        ...
		        <div class="col-xs-7 col-sm-7 col-md-8 thong-bao-tin-tuc">
		            ...
		            <a id="submittieudephu2" style="margin-top:5px;float:right;color:#bfa145;display:none;cursor:pointer;">Xác nhận</a>
	    ...
	    <div id="TTPhu3" style="display: none">
	    	<div class="col-xs-12 col-sm-12 col-md-12">
		        ...
		        <div class="col-xs-7 col-sm-7 col-md-8 thong-bao-tin-tuc">
		            ...
		            <a id="submittieudephu3" style="margin-top:5px;float:right;color:#bfa145;display:none;cursor:pointer;">Xác nhận</a>
